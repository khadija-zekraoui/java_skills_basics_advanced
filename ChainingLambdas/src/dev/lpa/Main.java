...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String,String> lastName = s -> s.concat(" Kamar");
        ...
        Predicate<String> p1 = s -> s.equals("LUNA");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Luna");
        Predicate<String> p3 = s -> s.startsWith("L");
